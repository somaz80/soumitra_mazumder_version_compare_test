...
VersionCompare library does not use other third party library to get the result. It uses simple arithmetic operators to decide which version string is greater.</br>
<b>Usage:</b></br>
One can import the VersionCompair library and  use it as below: </br>
        <p> <b>version_string_a = '1.2.1.1'  </br>
